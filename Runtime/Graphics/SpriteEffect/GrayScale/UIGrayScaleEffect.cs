...
namespace HP.Framework.Graphics
{
    ...
    public sealed class UIGrayScaleEffect : MonoBehaviour
    {
        ...
        private bool supportsEffectAmount;
        ...
        public void SetEffectAmount(float amount)
        {
            ...
            if (Mathf.Approximately(effectAmount, clamped) && instanceMaterial != null)
            {
                return;
            }

            effectAmount = clamped;
            EnsureMaterialInstance();
            ApplyMaterialProperties();
        }
        ...
        private void EnsureMaterialInstance()
        {
            ...
            supportsEffectAmount = instanceMaterial.HasProperty(EffectAmountId);
            targetImage.material = instanceMaterial;
        }

        private void ApplyMaterialProperties()
        {
            if (instanceMaterial != null && supportsEffectAmount)
            {
