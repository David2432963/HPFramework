...
/// <summary>
/// Editor Window hiển thị danh sách scene để mở nhanh.
/// Tích chọn "Build Settings Only" hoặc hiện tất cả scene trong project.
    ...
    private void DrawSceneList()
    {
        ...
        if (filteredScenes.Count == 0)
        {
            EditorGUILayout.HelpBox(
                _buildSettingsOnly
                    ? "Không có scene nào trong Build Settings."
                    : "Không tìm thấy scene nào.",
                MessageType.Info);
        ...
        foreach (var scene in filteredScenes)
        {
            ...
            {
                GUILayout.Space(22); // Align với checkbox
            }
